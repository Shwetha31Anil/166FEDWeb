...
public class PlayerDaoImpl implements PlayerDao {
	...
	public Player getPlayerById(int id)throws BuissnessException {
		...
		if(p1==null) {
			throw new BuissnessException("player not found for this id");
		}
		}catch(SQLException e) {
			throw new BuissnessException("sql error");
		}
		return p1;
	}
	@Override
	...
	public List<Player> getPlayerByDob(Date dob) throws BuissnessException {
		...
		try {
			...
			if(players.size()==0) {
				throw new BuissnessException("no player found for this dob");
			}
			}catch(SQLException e) {
				throw new BuissnessException("sql error");
			}
